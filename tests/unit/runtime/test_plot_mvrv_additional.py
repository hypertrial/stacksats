...
def test_plot_mvrv_metrics_autocomputes_missing_zscore_and_uses_long_range_locators(
    ...
    monkeypatch.setattr("stacksats.viz.plot_mvrv.plt.savefig", lambda *_args, **_kwargs: None)
    ...
    monkeypatch.setattr("stacksats.viz.plot_mvrv.mdates.YearLocator", _year_locator_spy)
    monkeypatch.setattr("stacksats.viz.plot_mvrv.mdates.MonthLocator", _month_locator_spy)
...
def test_plot_mvrv_metrics_uses_medium_range_date_locators(
    ...
    monkeypatch.setattr("stacksats.viz.plot_mvrv.mdates.MonthLocator", _month_locator_spy)
    monkeypatch.setattr("stacksats.viz.plot_mvrv.mdates.WeekdayLocator", _weekday_locator_spy)
...
def test_plot_mvrv_module_dunder_main_executes(
    ...
    monkeypatch.setattr(
        "stacksats.viz.plot_mvrv.BTCDataProvider.load",
    ...
    with pytest.raises(SystemExit) as excinfo:
        with warnings.catch_warnings():
            ...
            runpy.run_module("stacksats.viz.plot_mvrv", run_name="__main__")
