...
from ..data.prelude import (
    BACKTEST_END,
    BACKTEST_START,
    backtest_dynamic_dca as _backtest_dynamic_dca,
)
...
class StrategyRunner(StrategyRunnerValidationMixin):
    ...
    def _parse_daily_decision_config(
        ...
        if config.run_date is not None:
            ...
            from . import dt as runner_dt

            now = runner_dt.datetime.now(runner_dt.timezone.utc)
    ...
    def backtest(
        ...
        *,
        ...
        try:
            ...
            from . import backtest_dynamic_dca as runner_backtest_dynamic_dca

            spd_table, exp_decay_percentile, uniform_exp_decay_percentile = (
                runner_backtest_dynamic_dca(
                    btc_df,
                    strategy_fn,
