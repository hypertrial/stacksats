...
This document is the canonical strategy contract for the Stacking Sats problem: robustly acquiring more BTC than uniform DCA across a fixed Bitcoin accumulation budget and allocation horizon.
